...
<body>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <h1 class="text-center mb-5">Saved Vehicles</h1>
            <div class="row g-4">
                <%
            
                HandleVehicles handle = (HandleVehicles) context.getAttribute("Vehicles");
               DAO savedvehicles = new DAO();
                    boolean empty = true;
                    try{
                    for (Vehicle vehicle : savedvehicles.getSavedVehiclesForUser(loggedinuser.getuuid())) {
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    if(empty){
                %>
                <h1 class="text-center mb-5">No Saved Vehicles</h1>
                <%} %>
            </div>
        </div>
    </div>
