...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">All Vehicles<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
    <%
    ...
    String placeholder = ""; 
    try{
    	placeholder = (String) context.getAttribute("placeholder");
    	if(placeholder.isEmpty()){
        	placeholder = "CarGuy@Email.com";
        }
    }catch(NullPointerException e){
    	placeholder = "CarGuy@Email.com";
    }
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="bg-light rounded p-5">
                        ...
                        <form action="Accounts" method="get" onsubmit="return validatePassword()">
                            <div class="mb-3">
                                <label for="FullName" class="form-label">First Name</label>
                                <input required type="text" class="form-control" id="FullName" name="Fname" placeholder="First Name">
                            </div>
                            <div class="mb-3">
                                <label for="Lastname" class="form-label">First Name</label>
                                <input required type="text" class="form-control" id="Lastname" name="Lname" placeholder="Last Name">
                            </div>
                            <div class="mb-3">
                                <label for="Email" class="form-label">Email address</label>
                                <input <%if(placeholder != "CarGuy@Email.com"){%>
                                	value="<%=placeholder %>"
                         <%        }
                                	%> required type="email" class="form-control" id="Email" name="Email" placeholder="<%=placeholder%>">
