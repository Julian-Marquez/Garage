...
<body>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <h1 class="text-center mb-5">My Vehicles</h1>
            <div class="row g-4">
                <%
               ...
               // context.setAttribute("VehiclesList",vehiclelist);
                    ...
                    for (Vehicle vehicle : loggedinuser.getveiclelist()) {
                    	empty = false;
                %>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="vehicle-item bg-light p-4 position-relative">
                       ...
                       <button class="btn btn-primary py-3 px-4 mt-4" name="VehicleId" value="<%=vehicle.getUuid()%>" type="submit">See More</button>                        
                        </form>
                    </div>
                </div>
                    ...
                    if(empty){
                %>
                <h1 class="text-center mb-5">No Vehicles</h1>
                <%} %>
            </div>
        </div>
       <div class="text-center">
            <a href="AddVehicles.jsp" class="btn btn-primary py-3 px-4 mt-4">Add Vehicle</a>
        </div>
    </div>
    <!-- Vehicle List End -->
