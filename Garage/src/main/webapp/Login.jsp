                ...
                <div class="col-lg-6">
                    <div class="bg-light rounded p-5">
                        ...
                        <form action="Accounts" method="post">
                            ...
                            <div class="mb-3">
                            <button name="Loginpage" value="Login" type="submit" class="btn btn-primary w-100">Login</button>
                            </div>
                            <div class="mb-3">
                             <button name="Loginpage" value="Signup" type="submit" class="btn btn-primary w-100">Sign Up</button>
                             </div>
                              <div class="mb-3">
                             <button name="Forgot" value="Forgot" type="submit" class="btn btn-primary w-100">Recover</button>
                             </div>
                        </form>
                    </div>
                </div>
